...
def get_fid(path_data, path_pretrained, inception="", lowprofile=False):
    paths = [path_data, path_pretrained]
    fid_value = calculate_fid_given_paths(paths, inception, lowprofile)
    return fid_value
